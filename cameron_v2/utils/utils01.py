...
#     dumps = list()
#     cur_dir = os.getcwd()
#     filepaths = glob.glob(meta['annotation_folder'] + '/*.xml')
#     size = len(filepaths)
...
# 	# scale = 1.2
#     # scale = np.random.uniform() / 1
# 	max_offx = (scale-1.) * w
# 	max_offy = (scale-1.) * h
# 	offx = int(np.random.uniform() * max_offx) ###############################
# 	offy = int(np.random.uniform() * max_offy) ###############################
# 	# offx = int(0.4 * max_offx)
# 	# offy = int(0.3 * max_offy)
#
...
#             # print '[net/yolo/data.py: shuffle()] 987452895463: ', x_batch.shape
#             # What I'm interested is feed_batch, not x_batch.
